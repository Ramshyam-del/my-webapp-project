// Test script to test the trade history API with environment variables
...
async function testAPIWithEnv() {
  console.log('Testing trade history API with environment variables...');
  ...
  try {
    ...
    if (formattedTrades.length > 0) {
      console.log('✅ Sample formatted trade:', {
        id: formattedTrades[0].id,
        pair: formattedTrades[0].pair,
        type: formattedTrades[0].type,
        amount: formattedTrades[0].amount,
        resultStatus: formattedTrades[0].resultStatus,
        finalPnl: formattedTrades[0].finalPnl,
        isProfit: formattedTrades[0].isProfit
      });
    }
  } catch (error) {
